...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    havasProjectAuthUserSubject.add(
      HavasProjectAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<HavasProjectAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  HavasProjectAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = HavasProjectAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    havasProjectAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
HavasProjectAuthUser? currentUser;
